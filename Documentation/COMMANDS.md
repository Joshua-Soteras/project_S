...
> **TODO:** The NLP service has not been created yet (Step 3 in the build order).
> Commands will be added here once `nlp/` is scaffolded.
...
# TODO: Run the FastAPI service locally (http://localhost:8000)
uvicorn app.main:app --reload

# TODO: Run Python tests
pytest nlp/tests/ --cov=nlp --cov-report=html
```
...
```bash
# Start only the database (current workflow)
docker-compose up -d postgres

# TODO: Build and start all services (once backend + nlp Dockerfiles exist)
docker-compose up --build

# TODO: Start all services in the background
